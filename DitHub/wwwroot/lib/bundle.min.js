...
//! moment.js
return t.version="2.29.3",ih(l),t.fn=n,t.min=tv,t.max=iv,t.now=bo,t.utc=ot,t.unix=yw,t.months=ww,t.isDate=pi,t.locale=gt,t.invalid=rr,t.duration=et,t.isMoment=ut,t.weekdays=kw,t.parseZone=pw,t.localeData=bt,t.isDuration=nu,t.monthsShort=bw,t.weekdaysMin=gw,t.defineLocale=ff,t.updateLocale=ta,t.locales=ia,t.weekdaysShort=dw,t.normalizeUnits=tt,t.relativeTimeRounding=ek,t.relativeTimeThreshold=ok,t.calendarFormat=ty,t.prototype=n,t.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},t});$(document).ready(function(){$(".D").click(function(n){var t=$(n.target),i={Ditid:parseInt(t.attr("data-ditid"))};t.text().toString().includes("+ Fave Ditty?")?$.post({url:"/api/favedit",data:JSON.stringify(i),contentType:"application/json"}).done(function(n){t.css("box-shadow","0.5rem 0.5rem #ccc, -0.5rem -0.5rem #f93636").text("Added");console.log(n)}).fail(function(n,t,i){console.log("failed, "+i+n.responseText)}):$.ajax({url:"/api/favedit",data:JSON.stringify(i),method:"DELETE",contentType:"application/json"}).done(function(){t.css("box-shadow","0.5rem 0.5rem #ccc, -0.5rem -0.5rem #f93636").text("Removed")}).fail(function(n,t,i){alert("failed, "+i+n.responseText)})});$(".A").click(function(n){var t=$(n.target),i={FeeId:t.attr("data-Feeid")};$.post({url:"/api/followings",data:JSON.stringify(i),contentType:"application/json",dataType:"json"}).done(function(){t.css("box-shadow","0.5rem 0.5rem #ccc, -0.5rem -0.5rem #f93636").text("followed");alert("Request done!")}).fail(function(n,i,r){t.css("box-shadow","0.5rem 0.5rem #f93636, -0.5rem -0.5rem #ccc").text("failed");alert("failed, "+r+n.responseText)})})});