...
//! moment.js
return t.version="2.29.3",ih(l),t.fn=n,t.min=tv,t.max=iv,t.now=bo,t.utc=ot,t.unix=yw,t.months=ww,t.isDate=pi,t.locale=gt,t.invalid=rr,t.duration=et,t.isMoment=ut,t.weekdays=kw,t.parseZone=pw,t.localeData=bt,t.isDuration=nu,t.monthsShort=bw,t.weekdaysMin=gw,t.defineLocale=ff,t.updateLocale=ta,t.locales=ia,t.weekdaysShort=dw,t.normalizeUnits=tt,t.relativeTimeRounding=ek,t.relativeTimeThreshold=ok,t.calendarFormat=ty,t.prototype=n,t.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},t});var DitService=function(){var n=function(n,t,i){$.post({url:"/api/favedit",data:JSON.stringify(n),contentType:"application/json"}).done(t).fail(i)},t=function(n,t,i){$.ajax({url:"/api/favedit",data:JSON.stringify(n),method:"DELETE",contentType:"application/json"}).done(t).fail(i)};return{create:n,"delete":t}}(),DitController=function(n){var t,u=function(n){$(n).on("click",".D",f)},f=function(u){t=$(u.target);var f={Ditid:parseInt(t.attr("data-ditid"))};t.text().toString().includes("+ Fave Ditty?")?n.create(f,i,r):n.delete(f,i,r)},i=function(){var n=t.text()=="Added"?"Removed":"Added";t.css("box-shadow","0.5rem 0.5rem #ccc, -0.5rem -0.5rem #f93636").text(n)},r=function(n,t,i){alert("failed, "+i+n.responseText)};return{val:u}}(DitService),FollowService=function(){var n=function(n,t,i){$.post({url:"/api/followings",data:JSON.stringify(n),contentType:"application/json"}).done(t).fail(i)},t=function(n,t,i){$.ajax({url:"/api/followings",data:JSON.stringify(n),method:"DELETE",contentType:"application/json"}).done(t).fail(i)};return{create:n,"delete":t}}(),FollowController=function(n){var t,f=function(n){$(n).on("click",".A",e)},e=function(u){t=$(u.target);var f={FeeId:t.attr("data-Feeid")};t.text().toString().includes("+ Fave Artist?")?n.create(f,i,r):n.delete(f,i,r)},i=function(){var n=t.text()=="+ Fave Artist?"?"A Is + Fave.":"+ Fave Artist?",i=t.text()=="+ Fave Artist?"?"Followed":"Unfollowed";t.css("box-shadow","0.5rem 0.5rem #ccc, -0.5rem -0.5rem #f93636").text(i);u(n)},r=function(){var n=t.text();t.css("box-shadow","0.5rem 0.5rem #ccc, -0.5rem -0.5rem #f93636").text("Failed");u(n)},u=function(n){setTimeout(function(){var i=t.attr("data-Feeid"),r=t.text();t.css("box-shadow","0.5rem 0.5rem #f93636, -0.5rem -0.5rem #ccc").text(n);r!="Failed"&&$("[data-Feeid="+i+"]").each(function(){$(this).text(n);console.log($(this).text())})},2e3)};return{val:f}}(FollowService);