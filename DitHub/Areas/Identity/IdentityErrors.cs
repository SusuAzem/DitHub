...
namespace DitHub.Areas.Identity
{
    ...
    {       
            ...
            public override IdentityError DuplicateUserName(string userName) { return new IdentityError { Code = nameof(DuplicateUserName), Description = $"Email '{userName}' is already taken. الاسم غير متوفر" }; }
